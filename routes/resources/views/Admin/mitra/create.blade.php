    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form method="POST" action="{{url('admin/mitra/store')}}" enctype="multipart/form-data">
                    {{ csrf_field() }} 
                    <div class="box-body">
                         ...
                         <div class="form-group-sm">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Pelaksana" name="nama">
                            </div>
                        </div>
                        ...
                        <div class="form-group-sm">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Situs" name="site">
                            </div>
                        </div>
